...
class Utils:
    ...
    def upload_to_gcs(
        self, localfilename: str, bucket_name: str, destination_blob_name: str
    ):
        """
        Takes a local file in the Docker container's storage and uploads it to GCS.

        Args:
            localfilename (str): The path to the local file.
